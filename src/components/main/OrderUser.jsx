    ...
    return (
        <div className="OrderUser flex flex-col gap-8">
            <div className="flex fontBlod text-3xl gap-1">
                <p className=" text-doneBlue">С заботой о клиентах</p>
            </div>
            ...
            <div className="flex justify-center items-start gap-44 ml-24 ">
                <div className="fontRoman flex flex-col justify-center items-start gap-6">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='fontMedium text-mainTow text-2xl'>Сборные заказы (gifts case)</p>
                    </div>
                    <ul className='text-mainTow list-disc flex flex-col gap-4 w-56'>
                ...
                <div className="fontRoman flex flex-col justify-center items-start gap-6">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='fontMedium text-doneYellow text-2xl'>Персональный менеджер</p>
                    </div>
                    <ul className='text-doneYellow list-disc flex flex-col gap-4 w-56'>
                        ...
                        <div className="fontRoman flex flex-col justify-center items-start gap-6 ">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className='fontMedium text-doneBlue text-2xl'>Чем больше заказов, тем больше скидки</p>
                            </div>
                ...
                <div className="fontRoman flex flex-col justify-center items-start gap-6">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='fontMedium text-donePink text-2xl'>Персональный менеджер</p>
                    </div>
                    <ul className='text-donePink list-disc flex flex-col gap-4 w-56'>
